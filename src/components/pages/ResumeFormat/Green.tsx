...
const Green: React.FC<ChildProps> = ({ personInfo, phoneNo, email, address, employerDetails, company, skill, hiring, skillArray, name, jobTitle,lastName, linkDin, imagePreview, DisplayHtmlContent, selectedFontFamily,
    ...
    return (
        <>
            <Box sx={{ background: "#fff" }}>
                <Box>
                    <Box sx={{ width: "100%", background: "#a5d2a4", display:"flex", justifyContent:"space-between" }}>
                        <Box sx={{ padding: "30px" }}>
                        ...
                        {imagePreview ? (
                                <Box sx={{ textAlign: "center", margin:"6px 16px 2px 0px" }}>
                                    <img
                                        src={imagePreview}
                                        alt="User Icon"
