...
const Red: React.FC<ChildProps> = ({ personInfo, phoneNo, email, address, employerDetails, company, skill, hiring, skillArray, name, jobTitle, lastName, linkDin, imagePreview, DisplayHtmlContent, selectedFontFamily,
        ...
        <>
            <Box>
                <Box sx={{ display: "flex", boxSizing: "border-box", flexWrap: "nowrap", borderRadius: "10px", height: "100%" }}>
                    ...
                    <Box sx={{ width: "35%", minHeight: "100vh", background: "#c93232", padding: "0px" }}>
