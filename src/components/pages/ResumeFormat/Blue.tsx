...
const Blue: React.FC<ChildProps> = ({ personInfo, phoneNo, email, address, employerDetails, company, education, educationList, skill, hiring, skillArray, name, jobTitle, lastName, linkDin, imagePreview, experienceList, experience,
        ...
        <>
            <Box>
                <Box sx={{ display: "flex", boxSizing: "border-box", flexWrap: "nowrap", borderRadius: "10px", }}>
                    <Box className="sidenav" sx={{ width: "35%", minHeight: "100vh", background: "#0e1439", padding: "0px" }}>
